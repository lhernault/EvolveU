    ...
    render() {
       return(
           <div>
               ...
               <div className='lista'>
                   <button id='inputBtn' className = "btnlinklist" onClick={this.onStateChange}>Insert</button>
                   <button id='inputBtn' className = "btnlinklist" onClick={this.onDelete}>Delete</button>
                   <br/>
                   <button id='inputBtn' className = "btnlinklist" onClick={this.onFirstPosition}>First</button>
                   <button id='inputBtn' className = "btnlinklist" onClick={this.onLastPosition}>Last</button>
                   <button id='inputBtn' className = "btnlinklist" onClick={this.nextInPosition}>Next</button>
                   <button id='inputBtn' className = "btnlinklist" onClick={this.onPreviousPosition}>Previous</button>
                   <br/>
                   <button id='inputBtn' className = "btnlinklist" onClick={this.onTotal}>Total Amount</button>
                   <input value= {this.state.result}></input>
                   
                   <div className="sub-am">
